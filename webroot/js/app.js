    ...
    const tagList = (tags !== null && tags.length > 0)
      ? tags.map(
          (tag, index) => html`
            <li
              key="tag${index}"
              class="tag rounded-sm bg-gray-700 text-xs uppercase mr-3 mb-2 p-2 whitespace-no-wrap"
            >
              ${tag}
            </li>
          `
    ...
    return html`
      ...
      >
        <div id="top-content" class="z-50">
          ...
          >
            <h1
              class="flex flex-row items-center justify-start p-2 uppercase text-xl	font-thin tracking-wider overflow-hidden whitespace-no-wrap"
            >
              <span
                id="logo-container"
                class="inline-block w-8 min-w-8 min-h-8 h-8 mr-2 bg-no-repeat bg-center"
              >
        ...
        <main class=${mainClass}>
          ...
          <section
            ...
            class="flex text-center flex-row justify-between font-mono py-2 px-8 bg-gray-900 text-indigo-200 shadow-md "
          >
        ...
        <section id="user-content" aria-label="User information" class="p-8">
          <div class="user-content flex flex-row p-8">
            <div
              class="user-image p-4 mr-8 bg-no-repeat bg-center"
              style=${bgUserLogo}
            >
              <img class="logo visually-hidden" alt="" src=${logo} />
            </div>
            <div
              class="user-content-header"
            >
